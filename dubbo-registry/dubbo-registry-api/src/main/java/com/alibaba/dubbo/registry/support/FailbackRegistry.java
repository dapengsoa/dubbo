 ...
 * doRegister doUnRegister  doSubscribe doUnSubscribe 给子类实现
 */
public abstract class FailbackRegistry extends AbstractRegistry {
    ...
    /**
     * 对故障进行重试的定时器，定期检查是否有失败的请求，如果有的话，可以无限重试(an unlimited retry)。
     *
     * @ScheduledFuture 新知识
     */
    ...
    public FailbackRegistry(URL url) {
        ...
        this.retryFuture = retryExecutor.scheduleWithFixedDelay(new Runnable() {
            public void run() {
                ...
                try {
                    retry();
                } catch (Throwable t) { // Defensive fault tolerance 保护的容错机制
