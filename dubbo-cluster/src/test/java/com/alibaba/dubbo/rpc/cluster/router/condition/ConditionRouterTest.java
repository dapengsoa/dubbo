...
public class ConditionRouterTest {
    ...
    public void testRoute_matchWhen() {
        ...
        matchWhen = ((ConditionRouter) router).matchWhen(URL.valueOf("consumer://1.1.1.2/com.foo.BarService"),
                invocation);
        Assert.assertEquals(false, matchWhen);
    ...
    public void testRoute_methodRoute() {
        Invocation invocation = new RpcInvocation("getFoo1", new Class<?>[0], new Object[0]);
